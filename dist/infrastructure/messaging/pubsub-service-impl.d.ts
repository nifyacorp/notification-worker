 ...
 */
import { PubSubService, MessageHandler, ErrorHandler, SubscriptionStatus } from '../../domain/services/pubsub-service';
import { Logger } from '../../shared/logger/logger';
/**
 * GooglePubSubService implementation
 * Implements PubSub operations using Google Cloud PubSub
 */
export declare class GooglePubSubService implements PubSubService {
     ...
     */
    subscribe(topicName: string, subscriptionName: string, messageHandler: MessageHandler, errorHandler: ErrorHandler): Promise<void>;
    /**
