 ...
 */
export class RealEstateProcessor {
    notificationRepository;
    logger;
    processorType = ProcessorType.REAL_ESTATE;
    ...
    async process(message) {
        ...
        try {
            ...
            throw new ProcessorError(`Failed to process Real Estate message: ${error.message}`, ErrorCode.PROCESSOR_EXECUTION, {
...
//# sourceMappingURL=real-estate-processor.js.map